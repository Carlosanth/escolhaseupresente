    ...
    // ================================================================
    function redimensionarImagem(arquivo, larguraMax = 600, alturaMax = 600, qualidade = 0.82, manterProporcao = false) {
        return new Promise((resolve) => {
            ...
            reader.onload = (e) => {
                ...
                img.onload = () => {
                    ...
                    // manterProporcao=true: usado pra imagens paisagem (ex: temas/
                    // papel de parede) — só redimensiona, sem cortar em quadrado.
                    // Padrão (false) preserva o comportamento original, usado pelas
                    // fotos de produto do banco de imagens.
                    if (manterProporcao) {
                        canvas.width = w;
                        canvas.height = h;
    ...
    document.getElementById('inputTemaArquivo')?.addEventListener('change', async (e) => {
        ...
        // larga (1200x800), sem cortar em quadrado como as fotos de produto.
        const blob = await redimensionarImagem(arquivo, 1200, 800, 0.88, true);
